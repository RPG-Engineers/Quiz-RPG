                        ...
                        {tags.map((tag) => (
                            <div key={tag.id_tag} className="card mb-3">
                                <div className="card-body d-flex align-items-center justify-content-between">
                                    <span className="badge" style={{ backgroundColor: tag.color, color: "white" }}>
                                        {tag.name}
                                    </span>
                                    <div>
                                        <button type="button" className="btn btn-warning text-white" onClick={() => handleEdit(tag.id_tag)}>
                                            <i className="fa-solid fa-pen"></i>
                                        </button>
                                        <button type="button" className="btn btn-danger" onClick={() => handleDelete(tag.id_tag)}>
